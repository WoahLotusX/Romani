...
function DiscordLib:Window(text)
	...
	UserPanelUserIcon.MouseButton1Click:Connect(function()
		...
		ChangeBtn.BackgroundColor3 = Color3.fromRGB(245, 2, 4)
		...
		ChangeBtn.MouseEnter:Connect(function()
			TweenService:Create(
				ChangeBtn,
				TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = Color3.fromRGB(245, 2, 4)}
			):Play()
		end)
		...
		CloseBtn1.BackgroundColor3 = Color3.fromRGB(245, 2, 4)
		...
		ResetBtn.BackgroundColor3 = Color3.fromRGB(245, 2, 4)
	...
	EditBtn.MouseButton1Click:Connect(function()
		...
		ChangeBtn.MouseEnter:Connect(function()
			TweenService:Create(
				ChangeBtn,
				TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = Color3.fromRGB(140,2,4)}
			):Play()
		end)
	...
	function DiscordLib:Notification(titletext, desctext, btntext)
		...
		AlrightBtn.BackgroundColor3 = Color3.fromRGB(245, 2, 4)
	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:Button(text,callback)
				...
				Button.BackgroundColor3 = Color3.fromRGB(245, 2, 4)
			...
			function ChannelContent:Slider(text, min, max, start, callback)
				...
				CurrentValueFrame.BackgroundColor3 = Color3.fromRGB(245, 2, 4)
